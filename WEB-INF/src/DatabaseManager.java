...
public class DatabaseManager {
  ...
  private final String databaseDir = Paths.get("../database/").toAbsolutePath().normalize().toString();
	private final String USERS_PATH = databaseDir + "/users.txt";
	private final String CARTS_PATH = databaseDir + "/carts.txt";
  ...
  //   System.out.println(db.USERS_PATH);
  //   User user1 = new User("first1", "last", "mail1@", "1234"); 
  //   User user2 = new User("first2", "last", "mail2@", "1234"); 
  //   UserManager um1 = new UserManager();
  //   um1.userToRegister(user1);
  //   um1.userToRegister(user2);
  //   db.writeUsers(um1.getUsers());

  //   UserManager um2 = new UserManager(db.getUsers());
  //   System.out.println(um2.getUsers());
  //   um2.getUsers().forEach((K,V)->{
